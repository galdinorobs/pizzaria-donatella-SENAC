...
$('section.domingo-perfeito').waypoint( function(direcao){
    //direcao=representa um espaço resevado na memória que irá guardar como o usuário chegou naquele elemento html, as duas possibilidades serão up(subindo) ou down (descendo)
    if (direcao == 'down') {
...
$('section.plano-principal').waypoint(function(direcao) {
    if (direcao == 'down') {
        ...
        $('div.planos:eq(2)').addClass('animate__animated animate__fadeIntRight animate__slower');
} else {
